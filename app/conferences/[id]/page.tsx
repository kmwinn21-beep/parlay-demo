...
export default function ConferenceDetailPage() {
  ...
  /** When the agenda was last replaced, for the stamp beside the button. */
              ...
              <div className="md:col-span-2">
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    ...
                    {/* One door, the same one the agenda tab offers. The two
                        used to differ — outlined buttons with an inline URL box
                        here, a tabbed panel there — and only the modal can take
                        more than one link. */}
                    <div className="max-w-xs">
                      <UploadAgendaButton
                        conferenceId={Number(id)}
                        onUploaded={() => { setAgendaLastUploadedAt(new Date().toISOString()); }}
                      />
                    </div>
                  </div>
                  {(() => {
