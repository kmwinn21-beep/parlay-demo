        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          {sent ? (
            <div className="text-center">
              ...
              <h2 className="text-xl font-bold text-procare-dark-blue font-serif mb-2">Check your email</h2>
              <p className="text-sm text-gray-500 mb-6">
                If <strong>{email}</strong> has an account, we&apos;ve sent a password reset link. It expires in 1 hour.
              </p>
              <Link href="/auth/login" className="text-procare-bright-blue text-sm font-medium hover:underline">
                ← Back to sign in
              </Link>
            </div>
          ) : (
            <>
              <h1 className="text-2xl font-bold text-procare-dark-blue font-serif mb-1">Forgot password?</h1>
              <p className="text-sm text-gray-500 mb-6">
