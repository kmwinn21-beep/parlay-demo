  ...
  try {
    ...
    const result = await db.execute({
      sql: `SELECT a.id, a.first_name, a.last_name, a.title, a.company_id, a.email,
                   ...
                   co.icp as company_icp, co.services as company_services,
                   co.profit_type as company_profit_type, co.entity_structure as company_entity_structure,
                   co.assigned_user as company_assigned_user, co.website as company_website,
