...
async function runFullMigrations(): Promise<void> {
  ...
  const newCategorySeeds: Array<{ category: string; value: string; sort_order: number }> = [
    ...
    { category: 'company_type', value: 'Customer', sort_order: 9 },
    { category: 'company_type', value: 'Former Customer', sort_order: 10 },
    ...
    { category: 'event_type', value: 'Fundraiser', sort_order: 4 },
    ...
    { category: 'cost_type', value: 'Booth', sort_order: 4 },
    { category: 'cost_type', value: 'Booth Setup', sort_order: 5 },
    { category: 'cost_type', value: 'Travel', sort_order: 6 },
    { category: 'cost_type', value: 'Lodging', sort_order: 7 },
    { category: 'cost_type', value: 'Entertainment', sort_order: 8 },
    { category: 'cost_type', value: 'Meals', sort_order: 9 },
    { category: 'cost_type', value: 'Other', sort_order: 10 },
  ];
  ...
  const systemSeeds: Array<{ category: string; value: string }> = [
    ...
    { category: 'company_type', value: 'Customer' },
    { category: 'company_type', value: 'Former Customer' },
    ...
    { category: 'event_type', value: 'Fundraiser' },
    ...
    { category: 'cost_type', value: 'Booth' },
