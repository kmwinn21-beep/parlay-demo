          ...
          {filteredCompanyTypeData.length === 0 ? (
            ...
            <ResponsiveContainer width="100%" height={260}>
              <PieChart>
                ...
                />
                <Legend   align="center"   className="text-xs sm:text-sm"   wrapperStyle={{     fontSize: 'clamp(12px, 1vw, 14px)',     lineHeight: '1.8',     paddingTop: '14px',     marginTop: '14px',   marginRight: '12px'}} />
              </PieChart>
            </ResponsiveContainer>
          )}
        </div>
