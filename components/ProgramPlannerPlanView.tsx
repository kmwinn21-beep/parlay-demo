  ...
  return (
    <>
      <button
        ...
        className={`inline-flex items-center justify-center w-5 h-5 rounded-full text-red-500 hover:text-red-600 hover:bg-red-50 transition-opacity flex-shrink-0 disabled:opacity-50 ${
          alwaysVisible || open ? 'opacity-100' : 'opacity-0 group-hover:opacity-100 group-focus-within:opacity-100'
        }`}
      >
