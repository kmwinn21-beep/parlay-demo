  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50">
        ...
        {/* Drawer panel */}
        <div
          className="drawer-mobile-responsive fixed bottom-0 left-0 right-0 sm:inset-y-0 sm:left-auto sm:right-0 h-[90vh] sm:h-auto w-full sm:w-[420px] bg-white shadow-2xl flex flex-col rounded-t-2xl sm:rounded-none z-50"
        >
          {/* Header */}
