...
function InfoPopover({ title, children }: { title: string; children: ReactNode }) {
  ...
  return (
    <div className="relative" ref={wrapperRef}>
      ...
      {open && (
        <div className="absolute right-0 top-7 z-30 w-[min(30rem,85vw)] rounded-xl border border-gray-200 bg-white p-4 shadow-xl">
