...
export function DashboardNotificationsSection() {
  ...
  return (
    // The card is taken out of flow so its list length can't drive the grid
    // row — Targets sets the height, and the notifications scroll inside it.
    // 475px is the floor, including the card's own padding.
    <div className="relative min-h-[475px] h-full">
